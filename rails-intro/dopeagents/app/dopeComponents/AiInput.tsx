                    ...
                    <div className="relative flex flex-col">
                        ...
                        >
                                <Textarea
                                    id="ai-input-15"
                                    value={url}
                                    placeholder={"Please enter your companies url: (https://www.example.com)"}
                                    className={cn(
                                        "w-full rounded-xl rounded-b-none px-4 py-3 bg-black/5 dark:bg-white/5 border-none placeholder:text-black/70 dark:placeholder:text-white/70 resize-none focus-visible:ring-0 focus-visible:ring-offset-0",
                                        "min-h-[72px]",
                                        // Dynamic text color based on URL validity
                        ...
                        <div className="h-14 bg-black/5 dark:bg-white/5 rounded-b-xl flex items-center">
                            <div className="absolute left-3 right-3 bottom-3 flex items-center justify-between w-[calc(100%-24px)]">
                                ...
                                <GenerationManager url={url} isValidUrl={isValidUrl} />
