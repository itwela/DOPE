      ...
      {!toggleUrlInput && (
        <>
          ...
          <button
            ...
            className="bg-[#EB1416]/5 border border-[#EB1416]  hover:bg-[#EB1416] hover:text-white cursor-pointer px-3 py-2 rounded-lg font-medium transition-colors inline-flex items-center gap-2"
          >
            <InterviewIcon />
            Interview
          </button>
        ...
        <div className="w-full">
          <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              />
              <button
                className="bg-[#EB1416] cursor-pointer hover:bg-[#EB1416] text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2"
              ...
              <button
                ...
                className="px-2 py-2 cursor-pointer text-gray-500 hover:text-gray-700 transition-colors"
                title="Cancel"
              >
                Cancel
              </button>
